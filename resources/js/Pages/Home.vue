<template>
    <section>
        ...
        <InfiniteScroller :api-url="route('api.content', type)" :skeleton-count="10" wrapper-class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-6">
